 ...
 * via the logger.
 * @param {string[]} [opts.customFields=[]] - Custom fields for logger
 ...
 * @example
 * <caption>
 * You can also log custom properties from request
 * </caption>
 * server.get('/route/:name', function(req, res, next) {
 *
 *   // By default request does not contain "user" and "myRecord"
 *
 *   req.user = {
 *     id: 1
 *   }
...
function auditLogger(opts) {
    ...
    assert.optionalArrayOfString(opts.customFields, 'opts.customFields');
    ...
    var log = opts.log.child({
        ...
        serializers: {
            ...
            req: function auditRequestSerializer(req) {
                ...
                var fields = lodash.pick(req, opts.customFields);
                ...
                return Object.assign({}, reqLog, fields);
            },
