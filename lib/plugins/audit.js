...
function auditLogger(options) {
    ...
    //use logMetrics object to store certain period of log records
    var logMetrics = options.logMetrics;
    ...
    function audit(req, res, route, err) {
        ...
        if (logMetrics && logMetrics instanceof Object) {
            obj.timestamp = timestamp;
            logMetrics.pushLog(obj);
        }

        if (server && server instanceof Object) {
