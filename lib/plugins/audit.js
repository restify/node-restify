...
function auditLogger(options) {
    ...
    //use logMetrix object to store certain period of log records
    var logMetrix = options.logMetrix;
    ...
    function audit(req, res, route, err) {
        ...
        if (logMetrix && logMetrix instanceof Object) {
            obj.timestamp = timestamp;
            logMetrix.pushLog(obj);
        }
