...
var assertNumber = args.assertNumer;
...
function TokenBucket(options) {
        ...
        assertNumber('options.capacity', options.capacity);
        assertNumber('options.fillRate', options.fillRate);
...
function throttle(options) {
        assertObject('options', options);
        assertNumber('options.burst', options.burst);
        assertNumber('options.rate', options.rate);
