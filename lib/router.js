 ...
 * on paths
 * @param {Boolean} [options.useSemicolonDelimiter=false] - strip
 * semicolon-delimited matrix parameters (e.g. `;jsessionid=X`) from a path
 * segment before route matching, as `find-my-way`@7.x always did. Defaults to
 * `false` to match `find-my-way`@9.x behavior.
 */
