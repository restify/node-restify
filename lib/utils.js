...
/**
 * Returns only the media range portion of an accept header or content-type
 * header: 'application/json' becomes 'application/json; q=1; extension=value'
 * @param {acceptHeader} acceptHeader full accept-header
 * @returns {*}
 */
