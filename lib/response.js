...
function Response(options) {
  ...
  this.responseTimeFormatter = function(durationInMilliseconds) { return durationInMilliseconds; };
...
Response.prototype.defaultHeaders = function defaultHeaders() {
  ...
  this.header('Access-Control-Expose-Headers', EXPOSE_HEADERS + ', ' + this.responseTimeHeader);
