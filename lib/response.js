...
function patch(Response) {
    ...
    function redirect(arg1, arg2, arg3) {
        ...
        if (arg1 && !isNaN(arg1)) {
            ...
            var parsedRaw = utils.parseRequestUrl(
                opt.hostname || currentFullPath
            );
            finalUri = {
                port: parsedRaw.port,
                hostname: parsedRaw.hostname,
                query: utils.parseUrlQuery(
                    new URLSearchParams(parsedRaw.query || '')
                ),
                pathname: parsedRaw.pathname
            };
        ...
        redirectLocation = utils.formatUrl(finalUri);
