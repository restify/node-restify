...
/**
 * Add in the settings object a new configuration.
 * You can pass a fn or value for access in other parts of system
 * 
 * @public
 * @function setting
 * @param    {String}    setting the setting name.
 * @returns  {Object}         true or setting passed in argument.
 */
Server.prototype.setting = function set(setting, value) {
