...
function Server(options) {
  ...
  var name = options.name || 'restify';
  this.__defineGetter__('name', function() {
    return name;
  });

  var dtp = d.createDTraceProvider(this.name);
...
Server.prototype.listen = function listen(port, hostname, callback) {
  ...
  if (typeof(port) === 'number') {
    ...
    return this.server.listen(port, hostname, listenCallback);
    ...
    return this.server.listen(port, listenCallback);
  }
...
Server.prototype.del = function del(options) {
  ...
  return this._addRoute('DELETE', options, args);
};
...
Server.prototype.get = function get(options) {
  ...
  var args = Array.prototype.slice.call(arguments, 1);
  return this._addRoute('GET', options, args);
};
...
Server.prototype.head = function head(options) {
  ...
  var args = Array.prototype.slice.call(arguments, 1);
  return this._addRoute('HEAD', options, args);
};
...
Server.prototype.post = function post(options) {
  ...
  var args = Array.prototype.slice.call(arguments, 1);
  return this._addRoute('POST', options, args);
};
...
Server.prototype.put = function put(options) {
  ...
  var args = Array.prototype.slice.call(arguments, 1);
  return this._addRoute('PUT', options, args);
};
...
Server.prototype._request = function _request(req, res) {
  ...
  request._dtraceId = nextDTraceId();
  logRequest(request);
