 ...
 * @param {Boolean} [options.disableResponseFormatting=false] - disables
...
function Server(options) {
    ...
    assert.optionalBool(
        options.disableResponseFormatting,
        'options.disableResponseFormatting'
    );
    ...
    this.disableResponseFormatting = options.disableResponseFormatting || false;
...
Server.prototype._setupRequest = function _setupRequest(req, res) {
    ...
    res._disableResponseFormatting = this.disableResponseFormatting;
