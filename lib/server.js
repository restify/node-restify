 ...
 * *@param {Boolean} [options.useBuiltinFormatters=true] - determines whether
 * built-in formatters are included in set of formatters used to format
...
function Server(options) {
    ...
    this.useBuiltinFormatters = true;
    if (options.useBuiltinFormatters !== undefined) {
        this.useBuiltinFormatters = options.useBuiltinFormatters;
    }

    if (this.useBuiltinFormatters) {
        builtinFormatters = require('./formatters');
    }

    var fmt = mergeFormatters(options.formatters, builtinFormatters);
 ...
 * @param    {Object} builtinFmt built-in formatters object
 * @returns  {Object}
 */

function mergeFormatters(fmt, builtinFmt) {
    var arr = [];
    var obj = {};
    ...
    Object.keys(builtinFmt).forEach(addFormatter.bind(this, builtinFmt));
