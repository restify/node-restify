...
var assertBoolean = _args.assertBoolean;
var assertFunction = _args.assertFunction;
var assertNumber = _args.assertNumber;
var assertObject = _args.assertObject;
var assertString = _args.assertString;
...
function Server(options) {
        ...
        if (options.formatters) {
                Object.keys(options.formatters).forEach(function (k) {
                        assertFunction('formatter', options.formatters[k]);
