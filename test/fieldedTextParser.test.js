...
var CLIENT;
var SERVER;
var DATA_CSV = fs.readFileSync( __dirname + '/files/data-csv.txt', { encoding: 'utf8' });
var DATA_TSV = fs.readFileSync( __dirname + '/files/data-tsv.txt', { encoding: 'utf8' });
  ...
  CLIENT.post(options, function( err, req ) {
    ...
    req.on('result', function(err, res) {
      ...
      res.on('end', function() {
        ...
        t.equal(
          JSON.stringify(res.body.parsedReq),
          JSON.stringify(OBJECT_CSV)
        );
        t.end();
      });
    });
