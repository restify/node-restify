...
test('call highest versioned route when Accept-Version:*', function (t) {
    var server = restify.createServer();
    function response (req, res, next) {
        return res.send(req.route.version);
    }
    server.get({ path: '/ping', version: '1.0.2' }, response);
...
test('call route version mentioned in Accept-Version header', function (t) {
    var server = restify.createServer();
    function response (req, res, next) {
        return res.send(req.route.version);
    }
...
test('throw InvalidVersion on version mismatch', function (t) {
    var server = restify.createServer();
    function response (req, res, next) {
        return res.send(req.route.version);
    }
...
test('throw InvalidVersion on non-versioned route', function (t) {
    var server = restify.createServer();
    function response (req, res, next) {
        return res.send(req.route.version);
    }
